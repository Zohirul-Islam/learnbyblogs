  ...
  return (
    <div className='mx-8 sm:mx-20 xl:mx-32  relative'>
        <div className='mt-20 mb-8 text-center'>
            ...
            <form onSubmit={handleInput} className='flex overflow-hidden justify-between max-w-lg mx-auto border border-gray-300 rounded-full px-4 py-2'>
                <input ref={inputRef} className='w-full outline-0 pl-4' required type="text" placeholder='search for blogs' />
